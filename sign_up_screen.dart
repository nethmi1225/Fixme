                            ...
                            : SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    if (email.isEmpty || firstName.isEmpty || password.isEmpty || repeatPassword.isEmpty) {
                                    ...
                                    try {
                                      ...
                                      if (authViewModel.user != null) {
                                        print('Sign-up successful, user UID: ${FirebaseAuth.instance.currentUser!.uid}');
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(content: Text(authViewModel.errorMessage ?? 'Sign-up failed. Please try again.')),
                                        );
                                      }
                                    } catch (e) {
